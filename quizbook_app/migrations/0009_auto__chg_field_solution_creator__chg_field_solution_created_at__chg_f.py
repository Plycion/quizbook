...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Solution.creator'
        db.alter_column(u'quizbook_app_solution', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Solution.created_at'
        db.alter_column(u'quizbook_app_solution', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 29, 0, 0)))

        # Changing field 'Solution.updated_at'
        db.alter_column(u'quizbook_app_solution', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 29, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Solution.creator'
        db.alter_column(u'quizbook_app_solution', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Solution.created_at'
        db.alter_column(u'quizbook_app_solution', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Solution.updated_at'
        db.alter_column(u'quizbook_app_solution', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
    ...
    models = {
        ...
        u'quizbook_app.preamble': {
            'Meta': {'object_name': 'Preamble'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
