...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Preamble'
        db.create_table(u'quizbook_app_preamble', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=10000)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'quizbook_app', ['Preamble'])


    def backwards(self, orm):
        # Deleting model 'Preamble'
        db.delete_table(u'quizbook_app_preamble')
