...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solution.creator'
        db.add_column(u'quizbook_app_solution', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Solution.created_at'
        db.add_column(u'quizbook_app_solution', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Solution.updated_at'
        db.add_column(u'quizbook_app_solution', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Solution.creator'
        db.delete_column(u'quizbook_app_solution', 'creator_id')

        # Deleting field 'Solution.created_at'
        db.delete_column(u'quizbook_app_solution', 'created_at')

        # Deleting field 'Solution.updated_at'
        db.delete_column(u'quizbook_app_solution', 'updated_at')
